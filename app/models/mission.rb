class Mission < ApplicationRecord
  ...
  has_many :mission_user_roles, dependent: :destroy
  has_many :users, through: :mission_user_roles
  has_many :posts, as: :postable, dependent: :destroy
  belongs_to :dad, class_name: Mission, foreign_key: :parent

  def projects
    @projects ||= Mission.project_type.where(parent: self.id)
  end
